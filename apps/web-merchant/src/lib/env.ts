...
export const env = {
  NEXT_PUBLIC_APP_NAME: process.env.NEXT_PUBLIC_APP_NAME || 'Kuya Cares Merchant Portal',
  ...
  NEXT_PUBLIC_API_URL: process.env.NEXT_PUBLIC_API_URL || 'https://cms.kuyacares.com/api',
};
