...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({
      activeDeliveries: data.activeDeliveries ?? EMPTY_BODY.activeDeliveries,
      pendingOrders: data.pendingOrders ?? EMPTY_BODY.pendingOrders,
      recentOrders: data.recentOrders ?? EMPTY_BODY.recentOrders,
    });
  } catch {
