 ...
 * @description Authentication Context Provider for the customer web app.
 * Manages global authentication state with automatic session restoration.
 *
 * Logic ported 1:1 from the proven apps/web-admin pattern (contexts/AuthContext.tsx):
  ...
  const initializeAuth = useCallback(async () => {
    ...
    try {
      ...
      if (initialUser && initialToken) {
        try {
          persistMirror(initialUser, initialToken);
        } catch {
          void 0;
        }
