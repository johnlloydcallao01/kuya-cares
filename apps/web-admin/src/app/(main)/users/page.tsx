    ...
    <div className="space-y-6 py-5 px-2.5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white tracking-tight flex items-center gap-2">
            <span className="h-8 w-8 rounded-lg bg-[#239459] text-white flex items-center justify-center"><Users className="w-4 h-4" /></span>
            Users
          </h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/users/new" className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#239459] hover:bg-[#215035] text-white rounded-xl text-sm font-semibold shadow-sm transition">
      ...
      {stats ? (
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
          <KpiCard title="Total Users" value={String(stats.filteredTotal)} sub={`${stats.totalAll} overall`} icon={<Users className="w-5 h-5 text-white" />} iconBg="bg-[#239459]" />
      ...
      <div className="bg-white dark:bg-[#171717] rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm overflow-hidden">
        ...
        {isInitialLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
            ...
            <Link href="/users/new" className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-[#239459] text-white rounded-lg text-sm font-semibold"><Plus className="w-4 h-4" /> Create user</Link>
          </div>
        ) : !error && (
          <>
      ...
      {/* Delete confirm — delete-only when zero linked records, attribute-only when linked */}
            ...
            >
              ...
              <div className="mt-5 rounded-xl border border-gray-200 dark:border-[#262626] bg-gray-50 dark:bg-[#0a0a0a] p-4 space-y-4">
                {delDepsLoading && !delDepsData ? (
                  ...
                  <>
                    <div className="flex items-start gap-3 p-3 rounded-xl border bg-white dark:bg-[#171717] border-[#239459] ring-1 ring-[#239459]/30">
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-3">
                          <select
                            ...
                            className="w-full px-3 py-2.5 rounded-lg border border-gray-200 dark:border-[#262626] bg-white dark:bg-[#0a0a0a] text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#239459]/20 focus:border-[#239459] disabled:opacity-50 disabled:cursor-not-allowed"
                          >
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 min-h-0">
                {depsLoading && (
                  <div className="flex flex-col items-center justify-center py-16 gap-3">
                    <Loader2 className="w-7 h-7 animate-spin text-[#239459]" />
              ...
              <div className="px-6 py-4 border-t border-gray-100 dark:border-[#262626] bg-gray-50 dark:bg-[#0a0a0a] flex gap-2 shrink-0">
                ...
                {(depsData?.totalLinked ?? 0) > 0 && deleting && (
                  <button onClick={() => setViewingDeps(null)} className="flex-1 px-4 py-2.5 rounded-xl bg-[#239459] hover:bg-[#215035] text-white text-sm font-semibold shadow-sm transition">Back to delete options</button>
                )}
                {(depsData?.totalLinked ?? 0) > 0 && !deleting && (
        ...
        createPortal(
          <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={() => setDeleteError(null)}>
            ...
            >
              ...
              <div className="flex gap-2 mt-6">
                <button onClick={() => setDeleteError(null)} className="flex-1 px-4 py-2.5 rounded-xl bg-[#239459] hover:bg-[#215035] text-white text-sm font-semibold shadow-sm transition">Dismiss</button>
              </div>
            </div>
          </div>,
          document.body
