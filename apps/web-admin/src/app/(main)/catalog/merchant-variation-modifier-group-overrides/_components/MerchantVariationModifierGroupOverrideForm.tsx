  ...
  return (
    <div className="bg-white dark:bg-[#171717] rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm overflow-hidden">
      <div className="p-6 space-y-6">
        ...
        <div>
          <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><Layers className="w-4 h-4 text-[#239459]" /> Target Group Source</h4>
          <div className="flex gap-2">
            {TARGET_SOURCES.map((opt) => (
              <label key={opt.value} className={`flex-1 flex items-center gap-2 px-3 py-2.5 rounded-lg border cursor-pointer ${form.target_group_source === opt.value ? 'border-[#239459] bg-[#239459]/10' : 'border-gray-200 dark:border-[#262626] bg-white dark:bg-[#0a0a0a]'}`}>
                <input type="radio" name="target_group_source" value={opt.value} checked={form.target_group_source === opt.value} onChange={() => handleTargetToggle(opt.value)} className="h-4 w-4 text-[#239459]" />
        ...
        <div>
          <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><Package className="w-4 h-4 text-[#239459]" /> {form.target_group_source === 'product_base' ? 'Base Product Modifier Group' : 'Variation Modifier Group'}</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {form.mode === 'override' && (
          <div>
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><Hash className="w-4 h-4 text-[#239459]" /> Override Details</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
