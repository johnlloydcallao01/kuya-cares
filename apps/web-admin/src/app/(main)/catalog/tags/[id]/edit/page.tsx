  ...
  return (
    <div className="space-y-6 py-5 px-2.5">
      ...
      <div className="flex items-center gap-3">
        <div className="h-10 w-10 rounded-xl bg-[#239459] text-white flex items-center justify-center overflow-hidden" style={doc.color ? { backgroundColor: doc.color } : undefined}>
