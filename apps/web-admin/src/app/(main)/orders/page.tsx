    ...
    <div className="space-y-6 py-5 px-2.5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/orders/new" className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#239459] hover:bg-[#215035] text-white rounded-xl text-sm font-semibold shadow-sm transition">
      ...
      {stats ? (
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
          <KpiCard title="Total Orders" value={totalOrdersVal} sub={`${stats.totalAll} overall`} icon={<ShoppingBag className="w-5 h-5 text-white" />} iconBg="bg-[#239459]" />
          ...
          <KpiCard title="Revenue" value={revenueVal} sub={avgVal ? `avg ${avgVal}` : 'total revenue'} icon={<Receipt className="w-5 h-5 text-white" />} iconBg="bg-[#215035]" trend={avgVal ? `avg ${avgVal}` : undefined} />
        </div>
      ) : isInitialLoading ? (
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 animate-pulse">
                      ...
                      <tr key={String(o.id)} className="hover:bg-gray-50 dark:hover:bg-[#0a0a0a]/50 transition">
                        ...
                        <td className="px-4 py-3 hidden xl:table-cell">
                          <div className="flex items-center gap-2 min-w-[140px]">
                            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#239459] to-[#215035] text-white flex items-center justify-center text-[10px] font-bold shrink-0 overflow-hidden">
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="text-xs text-gray-500 dark:text-[#a1a1aa] truncate max-w-[140px] flex items-center gap-1"><Store className="w-3 h-3 text-[#239459]" /> {merchantVendor || o.merchant?.outletCode || '—'}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3">
                          ...
                          {o.lalamove?.trackingLink && <a href={o.lalamove.trackingLink} target="_blank" rel="noreferrer" className="block text-[11px] text-[#239459] hover:underline mt-1">Track</a>}
                        </td>
