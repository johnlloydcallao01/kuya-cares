...
export default function ActivityPage({ activity }: { activity: ActivityKey }) {
  ...
  return <div className="space-y-6 py-5 px-2.5">
    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      <div><h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white tracking-tight flex items-center gap-2"><span className="h-8 w-8 rounded-lg bg-[#239459] text-white flex items-center justify-center">{definition.icon}</span>{definition.title}</h1><p className="text-sm text-gray-500 dark:text-[#a1a1aa] mt-1">{definition.description}</p></div>
