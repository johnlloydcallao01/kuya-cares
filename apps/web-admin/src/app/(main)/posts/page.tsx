    ...
    <div className="space-y-6 py-5 px-2.5">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/posts/new" className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#239459] hover:bg-[#215035] text-white rounded-xl text-sm font-semibold shadow-sm transition">
      ...
      {posts.length > 0 || !isInitialLoading ? (
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
          <KpiCard title="Total Posts" value={String(totalDocs)} icon={<FileText className="w-5 h-5 text-white" />} iconBg="bg-[#239459]" />
      ...
      <div className="bg-white dark:bg-[#171717] rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm overflow-hidden">
        {isInitialLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
            <div className="h-16 w-16 bg-[#239459]/10 dark:bg-[#239459]/15 rounded-2xl flex items-center justify-center mb-4"><FileText className="w-8 h-8 text-[#239459]" /></div>
            ...
            <Link href="/posts/new" className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-[#239459] text-white rounded-lg text-sm font-semibold"><Plus className="w-4 h-4" /> Create post</Link>
          </div>
        ) : (
