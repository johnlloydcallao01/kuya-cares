      ...
      <div className="bg-white dark:bg-[#171717] rounded-xl border border-gray-200 dark:border-[#262626] shadow-sm overflow-hidden">
        ...
        {showTableSkeleton ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
            <div className="h-16 w-16 bg-[#239459]/10 dark:bg-[#239459]/15 rounded-2xl flex items-center justify-center mb-4"><Receipt className="w-8 h-8 text-[#239459]" /></div>
                      ...
                      <tr key={t.id} className="hover:bg-gray-50 dark:hover:bg-[#0a0a0a]/50 transition">
                        ...
                        <td className="px-4 py-3">
                          {order ? (
                            <div className="min-w-[120px]">
                              <Link href={`/orders/${order.id}`} className="font-semibold text-gray-900 dark:text-white hover:text-[#239459] text-xs flex items-center gap-1">
                                <ShoppingBag className="w-3 h-3 text-[#239459]" /> #{order.id}
                              </Link>
                        ...
                        <td className="px-4 py-3 hidden xl:table-cell">
                          <div className="min-w-[150px]">
                            <div className="text-xs font-medium text-gray-900 dark:text-white truncate max-w-[150px] flex items-center gap-1"><Store className="w-3 h-3 text-[#239459]" /> {merchantName}</div>
