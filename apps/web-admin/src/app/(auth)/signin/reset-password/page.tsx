            ...
            <div className="relative z-10 flex flex-col px-12 py-5 text-white w-full">
              <div className="max-w-md">
                <div className="mb-10">
                  ...
                  <p className="text-[#a7f3d0] text-lg font-medium">Admin Panel</p>
                </div>
                ...
                {isSuccess ? (
                  <div className="space-y-6">
                    ...
                    <button
                      type="button"
                      onClick={() => router.push('/signin')}
                      className="w-full bg-[#239459] hover:bg-[#215035] text-white py-3.5 px-6 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl border border-[#239459]/20"
                    >
                      Sign In
                    </button>
                  </div>
